...
function buildCompactFile() {
  return [
    ...
    '- Library size: 250+ copy-paste blocks, components, and variants (50 card blocks, 53 button variants, 25 website footers, 160+ component demos, 13 pre-built page blocks).',

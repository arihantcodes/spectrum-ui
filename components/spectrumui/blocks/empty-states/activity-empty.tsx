        ...
        {variant === 'Timeline' && (
          <div className="w-full max-w-[380px] text-left">
            ...
            <div className="relative pl-6">
              ...
              />
              <p className="mb-4 h-9 text-[12px] leading-[1.5] text-neutral-300 dark:text-neutral-600">
                nothing recorded
              </p>
              <motion.div
              ...
              >
                ...
                <p className="mt-0.5 font-mono text-[11px] text-neutral-300 dark:text-neutral-600">
                  {seed.at}
                </p>
              </motion.div>
            </div>

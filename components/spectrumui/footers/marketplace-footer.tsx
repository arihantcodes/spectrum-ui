            ...
            {categories.map((category, index) => (
              <li key={category.label} className={index === 0 ? "col-span-2 lg:col-span-1 lg:row-span-2" : ""}>
                <a
                  href={category.href}
                  className={cn(
                    "group flex h-full flex-col justify-between rounded-2xl border border-border p-4 transition-transform hover:-translate-y-0.5 hover:bg-muted/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",

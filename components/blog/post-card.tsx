...
export function PostCard({ post }: { post: BlogPost }) {
  return (
    <Link href={`/blog/${post.slug}`} className="group flex flex-col outline-hidden">
      ...
      <h3 className="mt-4 font-spectral text-[20px] font-medium leading-[1.2] tracking-[-0.02em] text-foreground text-balance">
        {post.title}
      </h3>

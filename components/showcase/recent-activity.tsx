      ...
      <div className="overflow-hidden rounded-[20px] border-[0.5px] border-neutral-300 bg-white dark:border-neutral-700 dark:bg-neutral-950">
        ...
        <div>
          {items.map((item, index) => (
            ...
            >
              <div className="flex w-[248px] shrink-0 items-center gap-1.5 pr-3">
                {item.icon ? (
              ...
              <div className="flex min-w-0 flex-1 items-center gap-3 self-stretch border-l border-neutral-200/60 pl-4 dark:border-neutral-800/60">

...
export function CommandSearch({
  ...
  // No dependency array on purpose: measuring one offsetTop per commit is
  // free, and it guarantees the pill can never hold a stale position while
  // the auto-typing filter reflows the list. The setState bails out when the
  ...
  return (
    <div
      ref={rootRef}
      className={cn(
        "relative flex w-full flex-col overflow-hidden rounded-[14px] bg-white p-2 pb-11",

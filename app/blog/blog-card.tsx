    ...
    >
      ...
      <span
        ...
        className={cn(
          ...
          emoji ? '' : 'font-regular font-semibold text-neutral-700/80 dark:text-white/70',
          glyphClassName,
        )}
      >
      ...
      <div className="flex flex-col-reverse md:grid md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between gap-8 p-7 md:min-h-[440px] md:p-11">
          ...
          <div className="flex items-center gap-2 font-inter text-[11px] uppercase tracking-[0.04em] text-neutral-500 dark:text-neutral-500">
            ...
            <span className="h-1 w-1 rounded-full bg-current opacity-50" />
            <span>{post.readTime}</span>
            <span className="ml-auto flex items-center gap-1 text-neutral-900 transition-colors group-hover:text-neutral-600 dark:text-neutral-200 dark:group-hover:text-neutral-300">
              Read
              <svg
                width="14"
                height="14"

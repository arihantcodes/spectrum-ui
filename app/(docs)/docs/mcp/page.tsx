...
function CodeBlock({ code, lang = "bash" }: { code: string; lang?: string }) {
  return (
    <div className="relative rounded-xl border border-neutral-200 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-900/50 overflow-hidden my-4">
      <div className="flex items-center gap-2 px-4 py-2 border-b border-neutral-200 dark:border-neutral-800 bg-neutral-100/50 dark:bg-neutral-950/20">
        <span className="text-[11px] font-mono text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">{lang}</span>
      </div>
      <pre className="p-4 overflow-x-auto text-sm">
        <code className="text-neutral-850 dark:text-neutral-200 font-mono leading-relaxed">{code}</code>
      </pre>
    </div>
  );
}
...
function EditorCard({
  ...
  return (
    <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 overflow-hidden">
      ...
      <div className="bg-neutral-50/50 dark:bg-neutral-950/50">
        <pre className="p-5 overflow-x-auto text-sm">
          <code className="text-neutral-850 dark:text-neutral-200 font-mono leading-relaxed">{configJson}</code>
        </pre>
      </div>
    </div>
  );
            ...
            <div className="grid sm:grid-cols-2 gap-3">
              {[
                ...
                <div key={t.tool} className="rounded-lg border border-neutral-200 dark:border-neutral-800 p-4">
                  <code className="text-xs font-mono text-neutral-800 dark:text-neutral-200 bg-neutral-100 dark:bg-neutral-800 px-2 py-0.5 rounded">
                    {t.tool}
                  </code>

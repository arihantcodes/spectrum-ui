...
const OptionTypeInfo = () => (
  <>
    <p>
      Option:{" "}
      <InlineCode>
        {"\u007B"} value: string; label: string; disable?: boolean; fixed?:
        boolean; [key:string]: string | undefined; {"\u007D"}
      </InlineCode>
      .
    </p>
    <p>
      The <InlineCode>[key:string]: string | undefined</InlineCode> is for you
      to customize <InlineCode> groupBy</InlineCode>
      field.
    </p>
  </>
);
...
export const multipleSelectorProp: Props[] = [
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          When you select or remove an option, the{" "}
          <InlineCode>onChange</InlineCode> will be called.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Only works with <InlineCode>onSearch</InlineCode> prop. Trigger search
          when <InlineCode>onFocus</InlineCode>.
        </p>
        <p>
          For example, when user click on the input, it will trigger the search
          to get initial options.
        </p>
      </>
    ),
    type: "boolean",
    ...
    description: (
      <>
        <p>
          ...
          <InlineCode>loadingIndicator</InlineCode> even if you provide it. The
          rest props are the same as async search. i.e.:{" "}
          <InlineCode>creatable</InlineCode>, <InlineCode>groupBy</InlineCode>,{" "}
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Show the loading component when <InlineCode>onSearch</InlineCode> is
          not finished.
        </p>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Customize the style by adding tailwind for the selected options
          (badge).
        </p>
      </>
    ),
  ...
  },
  {
    ...
    description: (
      <>
        <p>
          Pass a ref to the input element and retrieve the selected value as
          well.
        </p>
      </>
    ),

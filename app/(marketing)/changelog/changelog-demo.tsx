 ...
 */
export function ChangelogMedia({ media }: { media: NonNullable<ChangelogEntry['media']> }) {
  if (media.kind === 'terminal') {
    const tokens = media.command.split(' ');
    return (
      <div className="overflow-hidden rounded-[20px] border border-black/[0.08] bg-neutral-950 shadow-sm dark:border-white/[0.09] dark:bg-black">
        ...
        <div className="overflow-x-auto px-5 py-14 md:py-20">
